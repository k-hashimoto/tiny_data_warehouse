...
export function TableTree() {
  ...
  return (
    <>
      ...
      {dropConfirm && (
        <ConfirmDialog
          title={dropConfirm.type === "table" ? "テーブルを削除" : dropConfirm.type === "drop-all-tables" ? "全テーブルを削除" : "スキーマを削除"}
          description={
          ...
          destructive
          onConfirm={() => {
            if (dropConfirm.type === "table") executeDropTable(dropConfirm.schemaName, dropConfirm.tableName!);
